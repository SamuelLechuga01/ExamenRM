        ...
        <div class="flex justify-between items-center mb-1">
            <div class="h-10 flex items-center">
                ...
                <div class="w-96 flex rounded-lg shadow-sm">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" class="w-full pl-10 py-3 text-sm leading-4 block rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 focus:outline-none" placeholder="{{__('Buscar en')}} {{ $this->searchableColumns()->map->label->join(', ') }}" type="text" />
            ...
            <div class="flex flex-wrap items-center space-x-1">
                ...
                <div x-data="{ init() {
                    ...
                    <button wire:click="export" class="flex items-center space-x-2 px-3 border border-green-400 rounded-md bg-white text-green-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-green-200 focus:outline-none"><span>{{ __('Exportar') }}</span>
                ...
                <div class="table align-middle min-w-full">
                    ...
                    @empty
                        <p class="p-3 text-lg text-teal-600">
                            {{ __("No hay nada que mostrar por el momento") }}
                        </p>
                    @endforelse
                </div>
            </div>
