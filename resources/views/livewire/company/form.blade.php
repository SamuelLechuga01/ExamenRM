...
<form class="w-full">
    <div class="relative z-0 w-full mb-5">
        <input
          ...
          autocomplete="off"
        />
        <label for="name" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Empresa</label>
    ...
    <div class="relative z-0 w-full mb-5">
        <input
          ...
          autocomplete="off"
        />
        <label for="country" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">País</label>
    ...
    <div class="relative z-0 w-full mb-5">
        <input
          ...
          autocomplete="off"
        />
        <label for="address" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Dirección</label>
