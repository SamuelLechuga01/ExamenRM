<div>
    @if (Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-form-section submit="addTeamMember">
                <x-slot name="title">
                    {{ __('Añadir un miembro al equipo') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Añade un nuevo miembro a tu equipo, permitiéndole colaborar contigo.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Por favor, ingresa los siguientes datos. ') }}
                        </div>
                    </div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                <x-slot name="title">
                    {{ __('Invitaciones de equipos pendientes.') }}
                </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingLeavingTeam">
        ...
        <x-slot name="content">
            {{ __('¿Estás seguro de que quieres dejar este equipo?') }}
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingTeamMemberRemoval">
        <x-slot name="title">
            {{ __('Eliminar a un miembro del equipo.') }}
        </x-slot>
